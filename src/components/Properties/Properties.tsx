                            ...
                            <div className="relative">
                                ...
                                <div className="px-3 py-5">
                                    ...
                                    <div className="gap-4 mt-2 xl:flex">
                                        <div className="flex items-center justify-center px-2 py-1 rounded-lg my-2 bg-slate-300/30 font-semibold">
                                            <LiaBedSolid/>
                                            <span className="mx-2">{bedrooms}</span>
                                        </div>
                                        <div className="flex items-center justify-center px-2 py-1 rounded-lg my-2 bg-slate-300/30 font-semibold">
                                            <LiaBathSolid/>
                                            <span className="mx-2">{bathroom}</span>
                                        </div>
                                        <div className="flex items-center justify-center px-2 py-1 rounded-lg my-2 bg-slate-300/30 font-semibold">
                                            <LiaRulerCombinedSolid/>
                                            <span className="mx-2">{meters}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
